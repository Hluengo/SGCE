...
export const WizardStep4Plazos: React.FC<WizardStep4PlazosProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-right-8 duration-500 text-center">
      <div className="w-24 h-24 bg-blue-100 text-blue-600 rounded-3xl flex items-center justify-center mx-auto shadow-inner mb-6">
      ...
      <div className="bg-slate-50 rounded-3xl border border-slate-200 p-8 space-y-6 text-left">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-xs font-black uppercase tracking-tighter border border-red-100">

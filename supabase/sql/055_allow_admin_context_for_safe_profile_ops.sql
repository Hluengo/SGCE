...
-- Permite ejecutar funciones safe_* tanto con JWT superadmin como desde
-- contexto administrativo (SQL Editor / postgres / service_role).
-- ============================================================================

BEGIN;

CREATE OR REPLACE FUNCTION public.is_superadmin_or_admin_context()
RETURNS BOOLEAN
LANGUAGE sql
STABLE
AS $$
...
GRANT EXECUTE ON FUNCTION public.is_superadmin_or_admin_context() TO authenticated;
